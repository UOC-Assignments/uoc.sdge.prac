function(key, values) {
  ...
  var biomass_by_specie = values.reduce((acc, dictionary) => {
    Object.keys(dictionary).forEach(key => {
        ...
        // BUGFIX: He hagut d'implementar un workaround per a obviar algunes entrades
        // del diccionari de valors malformades (no he arribat a esbrinar el motiu del
        // perque em passa aixo). Exemple -> "Nezumia aequalis" : 241 .......... 22.08
